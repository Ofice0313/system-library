...
public class DepartmentController {
    ...
    public ResponseEntity<Page<DepartmentDTO>> findAll(Pageable pageable){
        Page<DepartmentDTO> dto = departmentService.findAll(pageable);
        return ResponseEntity.ok(dto);
    }
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<DepartmentDTO> update(@PathVariable Integer id, @Validated @RequestBody DepartmentDTO dto){
